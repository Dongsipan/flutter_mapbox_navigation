...
// Drop-in UI removed in SDK v3 - these imports no longer exist
...
/**
 * CustomInfoPanelEndNavButtonBinder - Temporarily disabled for SDK v3 MVP
 * Drop-in UI components removed in SDK v3, needs complete rewrite
 */
class CustomInfoPanelEndNavButtonBinder(
    val activity: Activity
) {
    // UIBinder interface removed in SDK v3
