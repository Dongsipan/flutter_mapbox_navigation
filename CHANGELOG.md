## 0.2.6
* 🚫 移除 Google Play Services 依赖 - 不再需要 Google Services 即可使用定位功能
* 🌍 改用 Android 原生 LocationManager - 提高设备兼容性
* 🇨🇳 支持中国大陆设备 - 在没有 Google Services 的设备上正常工作
* 📱 支持华为鸿蒙系统 - 兼容更多定制 ROM 和企业设备
* ⚡ 优化定位速度 - 优先使用缓存位置，快速响应
* 🔋 降低电量消耗 - 使用单次位置更新而非持续监听
* ⏱️ 添加定位超时机制 - 10秒超时避免无限等待
* 🐛 修复 autoBuildRoute=true 时的 Google Service 错误
* 📦 减小应用体积 - 移除不必要的依赖
* ✅ 完全向后兼容 - 无需修改任何代码
